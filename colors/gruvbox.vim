...
let s:gb.dark0_soft  = ['#302f32', 236]     " 50-48-47
let s:gb.dark1       = ['#38363c', 237]     " 60-56-54
let s:gb.dark2       = ['#494550', 239]     " 80-73-69
let s:gb.dark3       = ['#5c5466', 241]     " 102-92-84
let s:gb.dark4       = ['#6f647c', 243]     " 124-111-100
let s:gb.dark4_256   = ['#6f647c', 243]     " 124-111-100
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:bg4, s:none)
endif
...
call s:HL('StatusLine', s:fg2, s:none)
call s:HL('StatusLineNC', s:fg4, s:none)

" The column separating vertically split windows
call s:HL('VertSplit', s:fg4, s:none)
