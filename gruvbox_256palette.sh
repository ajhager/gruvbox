...
if [ "${TERM%%-*}" = "screen" ]; then
  if [ -n "$TMUX" ]; then
    printf "\033Ptmux;\033\033]4;236;rgb:30/2f/32\007\033\\"
    printf "\033Ptmux;\033\033]4;234;rgb:1d/20/21\007\033\\"

    printf "\033Ptmux;\033\033]4;235;rgb:28/28/28\007\033\\"
    printf "\033Ptmux;\033\033]4;237;rgb:38/36/3d\007\033\\"
    printf "\033Ptmux;\033\033]4;239;rgb:49/45/50\007\033\\"
    printf "\033Ptmux;\033\033]4;241;rgb:5c/54/66\007\033\\"
    printf "\033Ptmux;\033\033]4;243;rgb:6f/64/7c\007\033\\"
    ...
    printf "\033P\033]4;236;rgb:30/2f/32\007\033\\"
    printf "\033P\033]4;234;rgb:1d/20/21\007\033\\"

    printf "\033P\033]4;235;rgb:28/28/28\007\033\\"
    printf "\033P\033]4;237;rgb:38/36/3c\007\033\\"
    printf "\033P\033]4;239;rgb:49/45/50\007\033\\"
    printf "\033P\033]4;241;rgb:5c/54/66\007\033\\"
    printf "\033P\033]4;243;rgb:6f/64/7c\007\033\\"
  ...
  printf "\033]4;236;rgb:30/2f/32\033\\"
  printf "\033]4;234;rgb:1d/20/21\033\\"

  printf "\033]4;235;rgb:28/28/28\033\\"
  printf "\033]4;237;rgb:38/36/3c\033\\"
  printf "\033]4;239;rgb:49/45/50\033\\"
  printf "\033]4;241;rgb:5c/54/66\033\\"
  printf "\033]4;243;rgb:6f/64/7c\033\\"
