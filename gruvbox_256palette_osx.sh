...
if [ "${TERM%%-*}" = "screen" ]; then
  if [ -n "$TMUX" ]; then
    printf "\033Ptmux;\033\033]4;236;rgb:24/23/26\007\033\\"
    printf "\033Ptmux;\033\033]4;234;rgb:16/18/19\007\033\\"

    printf "\033Ptmux;\033\033]4;235;rgb:1e/1e/1e\007\033\\"
    printf "\033Ptmux;\033\033]4;237;rgb:2a/29/2e\007\033\\"
    printf "\033Ptmux;\033\033]4;239;rgb:39/35/3f\007\033\\"
    printf "\033Ptmux;\033\033]4;241;rgb:4a/42/53\007\033\\"
    printf "\033Ptmux;\033\033]4;243;rgb:5c/51/68\007\033\\"
    ...
    printf "\033P\033]4;236;rgb:24/23/26\007\033\\"
    printf "\033P\033]4;234;rgb:16/18/19\007\033\\"

    printf "\033P\033]4;235;rgb:1e/1e/1e\007\033\\"
    printf "\033P\033]4;237;rgb:2a/29/2e\007\033\\"
    printf "\033P\033]4;239;rgb:39/35/3f\007\033\\"
    printf "\033P\033]4;241;rgb:4a/42/53\007\033\\"
    printf "\033P\033]4;243;rgb:5c/51/68\007\033\\"
  ...
  printf "\033]4;236;rgb:24/23/26\033\\"
  printf "\033]4;234;rgb:16/18/19\033\\"

  printf "\033]4;235;rgb:1e/1e/1e\033\\"
  printf "\033]4;237;rgb:2a/29/2e\033\\"
  printf "\033]4;239;rgb:39/35/3f\033\\"
  printf "\033]4;241;rgb:4a/42/53\033\\"
  printf "\033]4;243;rgb:5c/51/68\033\\"
